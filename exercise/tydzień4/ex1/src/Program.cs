    ...
    public class Person
    {
        ...
        public Person(string firstName, string lastName, DateTime dateOfBirth)
        {
            ...
            if (string.IsNullOrWhiteSpace(lastName))
                throw new ArgumentException("Nazwisko nie moze być puste.", nameof(lastName));
            if (dateOfBirth > DateTime.Now)
                throw new ArgumentOutOfRangeException(nameof(dateOfBirth), "Data urodzenia nie moze być w przyszłości.");
    ...
    public class Student : Person
    {
            ...
            : base(firstName, lastName, dateOfBirth) 
        {
            ...
            if (string.IsNullOrWhiteSpace(major))
                throw new ArgumentException("Kierunke nie moze byc pusty", nameof(major));
